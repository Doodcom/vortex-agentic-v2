...
import { ChevronRight, MessageSquare, RotateCcw } from 'lucide-react'
...
export default function TerminalSession({
  entries, active, input, setInput, ghostSuffix, matchedIds, onKeyDown, onPaste, onFocus, onAskAI, onClear
              ...
              >
                ...
                {entry.exitCode !== null && (
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginLeft: '12px' }}>
                    ...
                    <button
                      onClick={e => { e.stopPropagation(); onAskAI(entry) }}
                      style={{ display: 'flex', alignItems: 'center', gap: '4px', padding: '2px 6px', borderRadius: '4px', background: 'rgba(239,68,68,0.06)', border: '1px solid rgba(239,68,68,0.12)', color: '#52525b', fontSize: '8px', fontFamily: 'monospace', textTransform: 'uppercase', cursor: 'pointer' }}
                    >
                      <MessageSquare size={8} /> Ask AI
                    </button>
                  </div>
                )}
              </motion.div>
